...
urlpatterns = [
     ...
     path('servicios/<int:categoria>', views.api_lista_servicios, name='API_get_servicios_categoria'),
     ...
     path('horarios_servicio_disponibles/<int:id_categoria>/<int:año>/<int:mes>/<int:dia>', views.horario__disponible_servicio, name='API_horarios_servicio'),
]
